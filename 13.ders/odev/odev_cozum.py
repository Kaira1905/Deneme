...
#         if not self.acik:
#             self.acik = True
#             print(f"{self.marka} - {self.model} bilgisayarınız açıldı. Kullanıma hazır.")
#         else:
...
#     def __str__(self):
#         return f"{self.marka} - {self.model} (RAM: {self.ram}, Depolama: {self.depolama})"
...
# pc1 = Bilgisayar("Lenovo", "MT-313", "16GB", "512GB")
# pc2 = Bilgisayar("Samsung", "Skyline-7", "32GB", "1TB")
# pc3 = Bilgisayar("Apple", "MacBook5", "32GB", "512GB")
...
class Hayvan:
    ...
    def bilgileri_goster(self):
        return f"Ad: {self.isim}, Yaş: {self.yas}, Ayak sayisi: {self.ayak_sayisi}"
...
class Kus(Hayvan):
    ...
    def bilgileri_goster(self):
        # override
        return super().bilgileri_goster() + " Kanat uzunluğu: " + str(self.kanat_uzunlugu)
